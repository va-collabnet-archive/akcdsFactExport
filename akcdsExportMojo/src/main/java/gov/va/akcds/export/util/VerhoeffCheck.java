...
public class VerhoeffCheck {
    ...
    */
       ...
       {
    	   System.out.println(validateVerhoeff("900000000000521006"));  //good
    	   System.out.println(validateVerhoeff("116680003")); //good
    	   System.out.println(validateVerhoeff("123452")); //bad
       }
}
